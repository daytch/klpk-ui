    ...
    <>
      ...
      <section>
        <div className="container space-y-6 py-10">
          ...
          <div className="leading-[180%]">
            <h2 className="text-base font-bold text-gold-200 mb-3">Log Data</h2>
            <p className="text-base text-kplkWhite mb-2">
          ...
          <div className="leading-[180%]">
            <h2 className="text-base font-bold text-gold-200 mb-3">Cookies</h2>
            <p className="text-base text-kplkWhite mb-2">
          ...
          <div className="leading-[180%]">
            <h2 className="text-base font-bold text-gold-200 mb-3">Security</h2>
            <p className="text-base text-kplkWhite mb-2">
